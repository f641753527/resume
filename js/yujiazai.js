...
var arr = ['img/fall.png','img/jumpinthesea.png','img/swim2.png','img/walk.png','img/far-forest.png','img/ground.png',
			'img/grass.png','img/tree-1.png','img/tree-2.png','img/tree-3.png','img/title.png','img/mountain.png',
			'img/mountain2.png','img/Tinyplane.png','img/ballon.png','img/mountain3.png','img/wood%20board.png',
			'img/dataDEMO/windomill.png'];
var n1 = new Image();
var n2 = new Image();
...
function showKeynotice() {
    fallAnimation.setAttribute('class','ALLdisplayshow');
}
...
function preloadimages(n){	
	newimages[n]=new Image();
	newimages[n].index = n;
	newimages[n].src = arr[n];
	newimages[n].onload = function () {
      console.log("n:"+n);
